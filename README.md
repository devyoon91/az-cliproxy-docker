...
| [docs/agent-profiles.md](docs/agent-profiles.md) | 에이전트 프로필 가이드 (developer, reviewer, devops) |
| [docs/backup.md](docs/backup.md) | 백업 및 복원 가이드 (스크립트 + Telegram) |
| [docs/optimization.md](docs/optimization.md) | 비용 최적화 가이드 (모델 선택, 설정, 예산 관리) |
